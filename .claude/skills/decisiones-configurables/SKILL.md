...
| ¿Cuántos? | cuántos contratos, clientes y prospectos por viático |
...
| ¿Se permite o no? | mezclar contratos con visitas en un mismo viaje |
...
- En **Configuración → <módulo>**, una tarjeta por política.
- La guarda quien **administra ese módulo** (`viaticos: administrar`), no quien
  administra el sistema: quien decide cuánto se paga por noche de hotel es quien
  administra el gasto. Con el guardia de `configuracion`, el rol General ni
  siquiera podía abrir la pantalla.
