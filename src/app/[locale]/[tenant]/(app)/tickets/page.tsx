...
import { countTicketsForUser, getTicketsForUser } from "@/lib/data/tickets";
...
export default async function TicketsPage({
  ...
  const [tickets, total] = await Promise.all([
    ...
    countTicketsForUser(session!.user.id),
  ]);
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        {total > 0 && <Pagination {...pageParams} total={total} basePath="/tickets" />}
      </Card>
    </div>
  );
}
